...
//
//        Transform t = {Maths::Vector3f{0, -1, 0}, Maths::Vector3f::One() * 0.2f,
...
//        Component::Model md = engine.GetResourcesManager().LoadModel(R"(../../Game/Asset/Model/Vampire.fbx)",
//                                                                     Renderer::VertexType::V_SKELETAL);
//
//        Material material;
//
...
//        Component::Model mdTrigger = engine.GetResourcesManager().LoadModel(R"(../../Game/Asset/Model/Cube.fbx)",
...
//        Component::Model mdContact = engine.GetResourcesManager().LoadModel(R"(../../Game/Asset/Model/Cube.fbx)",
//                                                                            Renderer::VertexType::V_NORMALMAP);
