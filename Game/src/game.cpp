...
void Game::Init(Engine &engine)
{
...

    {
        ...
        Resources::Model md = engine.GetResourcesManager().LoadModel(R"(../../Game/Asset/Model/Vampire.fbx)",
                                                                     Renderer::VertexType::V_SKELETAL);
...
//Test contactCollision
        ...
        Resources::Model mdFloor = engine.GetResourcesManager().LoadModel(R"(../../Game/Asset/Model/Cube.fbx)",
                                                                          Renderer::VertexType::V_NORMALMAP);
