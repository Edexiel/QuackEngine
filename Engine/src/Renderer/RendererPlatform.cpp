...
Mesh RendererPlatform::CreateMesh(const float *vertices, unsigned int verticesSize, const unsigned int *indices,
                                  unsigned int indicesSize, VertexType vertexType)
{
...
void RendererPlatform::VerticesReadingNormalMapping()
{
    ...
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, sizeof(NormalMapVertex),
                          (const GLvoid *) offsetof(NormalMapVertex, position));
    glEnableVertexAttribArray(0);
    glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, sizeof(NormalMapVertex),
                          (const GLvoid *) offsetof(NormalMapVertex, normal));
    glEnableVertexAttribArray(1);
    glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, sizeof(NormalMapVertex),
                          (const GLvoid *) offsetof(NormalMapVertex, uv));
    glEnableVertexAttribArray(2);
    glVertexAttribPointer(3, 3, GL_FLOAT, GL_FALSE, sizeof(NormalMapVertex),
                          (const GLvoid *) offsetof(NormalMapVertex, tangent));
    glEnableVertexAttribArray(3);
    glVertexAttribPointer(4, 3, GL_FLOAT, GL_FALSE, sizeof(NormalMapVertex),
                          (const GLvoid *) offsetof(NormalMapVertex, biTangent));
...
void RendererPlatform::VerticesReadingSkeletalMesh()
{
    ...
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, sizeof(SkeletalVertex),
                          (const GLvoid *) offsetof(SkeletalVertex, position));
    glEnableVertexAttribArray(0);
    glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, sizeof(SkeletalVertex),
                          (const GLvoid *) offsetof(SkeletalVertex, normal));
    glEnableVertexAttribArray(1);
    glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, sizeof(SkeletalVertex),
                          (const GLvoid *) offsetof(SkeletalVertex, uv));
    glEnableVertexAttribArray(2);
    glVertexAttribPointer(3, 3, GL_FLOAT, GL_FALSE, sizeof(SkeletalVertex),
                          (const GLvoid *) offsetof(SkeletalVertex, boneId));
    glEnableVertexAttribArray(3);
    glVertexAttribPointer(4, 3, GL_FLOAT, GL_FALSE, sizeof(SkeletalVertex),
                          (const GLvoid *) offsetof(SkeletalVertex, weights));
    glEnableVertexAttribArray(4);
}
...
void RendererPlatform::ResizeFramebuffer(unsigned int fbo, unsigned int rbo, unsigned int texture, unsigned int width,
                                         unsigned int height)
{
...
void RendererPlatform::SetTextureImage2D(unsigned char *image, unsigned int nrChannels, unsigned int width,
                                         unsigned int height)
{
    if (nrChannels == 4)
...
void RendererPlatform::SetSpotLight(unsigned int shaderID, unsigned int index, const Component::Light &light)
{
...
void RendererPlatform::SetDirectionalLight(unsigned int shaderID, unsigned int index, const Component::Light &light)
{
...
void RendererPlatform::SetPointLight(unsigned int shaderID, unsigned int index, const Light &light)
{
